...
const activityIcons: Record<ActivityType, LucideIcon> = {
  ...
  project_started: FolderPlus,
  room_appearance_updated: Palette,
  room_resized: Ruler,
  item_source_changed: Tag,
  item_elevation_changed: MoveVertical,
  opening_added: DoorOpen,
  opening_moved: DoorOpen,
  opening_removed: DoorOpen,
  opening_resized: DoorOpen,
